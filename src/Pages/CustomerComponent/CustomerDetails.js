...
<div className="bg-blueGray-100 min-h-screen w-full">
      <div className="p-3">
        ...
        <div className="p-6 bg-white  min-h-screen rounded-2xl  ps-5 pt-3 pe-5">
                    ...
                    <div className="bg-white p-4 rounded-xl shadow-sm border mb-5">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-semibold mb-2 font-Gilroy text-[#222222] overflow-hidden text-ellipsis whitespace-nowrap">{customer.contactPerson}</p>
                            </div>
                            <div>
                        ...
                        <hr className='mt-2 mb-[8px] border-1 border-[#E7E7E7] ' />
                        {
                            customer?.bankDetails?.map((bank, index) => {
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-semibold mb-2 font-Gilroy text-[#222222] overflow-hidden text-ellipsis whitespace-nowrap">{bank.name}</p>
                                </div>
                                <div>
                                    <p className="text-xs font-semibold mb-2 font-Gilroy text-[#4B4B4B]">Beneficiary Account Number</p>
                                    <p className="text-sm font-semibold mb-2 font-Gilroy text-[#222222] overflow-hidden text-ellipsis whitespace-nowrap">{bank.accountNo}</p>
                                </div>
                                <div>
                                    <p className="text-xs font-semibold mb-2 font-Gilroy text-[#4B4B4B]">Email</p>
                                ...
                                <div>
                                    <p className="text-xs font-semibold mb-2 font-Gilroy text-[#4B4B4B]">Bank Address 1</p>
                    ...
                    <div className="grid gap-4">
                            {
                                customer?.address?.map(item => {
                                    ...
                                    <h3 className="text-base font-semibold mb-2 font-Gilroy text-black">{item.addressType === 1 ? 'Office Address' : 'Shipping Address'}</h3>
                                    ...
                                    <p className="text-sm font-semibold mb-2 font-Gilroy text-[#222222] overflow-hidden text-ellipsis whitespace-nowrap">{item.address3 || 'N/A'}</p>
