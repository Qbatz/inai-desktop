    ...
    return (
        <div className="bg-blueGray-100 min-h-screen w-full">
            <div className="p-3">
                ...
                <div class="p-6 bg-white  min-h-screen rounded-2xl  ps-5 pt-3 pe-5  min-h-fit">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-12 p-2 ">
                        ...
                        <>
                                ...
                                <div class="bg-white p-4 rounded-xl shadow-sm border mb-5 ">
                                    ...
                                    <div class="grid grid-cols-2 gap-4 text-sm text-gray-600 ">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm font-semibold mb-2 font-Gilroy text-[#222222] overflow-hidden text-ellipsis whitespace-nowrap">{customer.title}.{customer.contactPerson}</p>
                                        </div>
                                        <div>
                                       ...
                                       customer?.bankDetails?.map((bank, index) => {
                                            return index === 0 && <div key={index} class="grid grid-cols-2 gap-4 text-sm text-gray-600">
                                                <div>
                                                    ...
                                                    <p class="text-sm font-semibold mb-2 font-Gilroy text-[#222222] overflow-hidden text-ellipsis whitespace-nowrap">{bank.name || 'N/A'}</p>
                                                </div>
                                                <div>
                                                    <p class="text-xs font-semibold mb-2 font-Gilroy text-[#4B4B4B]">Beneficiary Account Number</p>
                                                    <p class="text-sm font-semibold mb-2 font-Gilroy text-[#222222] overflow-hidden text-ellipsis whitespace-nowrap">{bank.accountNo || 'N/A'}</p>
                                                </div>
                                                <div>
                            ...
                            <div class=" bg-white p-4 rounded-xl shadow-sm border min-h-fit ">
                                <div className='flex items-center justify-between'>
