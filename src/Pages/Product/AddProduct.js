...
<div className="flex gap-4 mt-2">
  ...
  {/* <Slider {...settings}>
    {images.map((img, index) => (
      <div key={index} className="px-2">
        <div className="w-36 h-[135px] border rounded-md relative">
          <img
            src={img}
            alt={`Uploaded-${index}`}
          ...
          <div className="absolute inset-0 flex items-center justify-center rounded-md">
            <div
              ...
              onClick={() => handleImageDelete(index, setImages)}
            >
              <img
                src={Trash}
  ...
  <div className="relative w-[480px] mt-2">
      <Slider {...settings}>
        {images.map((img, index) => (
          <div key={index} className="px-2">
            <div className="w-36 h-[135px] border rounded-md overflow-hidden">
...
{/* Add Image Box (outside slider) */}
<div className="w-36 h-[135px] border-dashed border flex flex-col items-center justify-center rounded-md cursor-pointer">
  <label>
...
<label className="block font-normal text-sm font-Outfit mt-7">Technical</label>

<div className="flex flex-wrap gap-4 mt-2">
 
{techImages.slice(0, 3).map((file, index) => (
  <div
    key={index}
    className="relative w-36 h-[135px] border rounded-md flex items-center justify-center text-center"
  >
    {file.type.startsWith("image/") ? (
      ...
      <div className="flex flex-col items-center justify-center w-full h-full px-1 text-center">
        <a
          href={file.preview}
          target="_blank"
    ...
    <div className="absolute inset-0 flex items-center justify-center rounded-md mt-24">
      <div
        className="flex items-center space-x-3 px-4 py-2 rounded-full bg-pink-200 bg-opacity-50 cursor-pointer"
  ...
  <label className="w-36 h-[138px] border-dashed border flex flex-col items-center justify-center rounded-md cursor-pointer">
    <img src={addcircle} alt="addcircle" className="w-6 h-6 mb-1" />
    <span className="font-Gilroy font-semibold text-xs text-blue-700 text-center">Add Documents</span>
...
<div className="grid grid-cols-1 md:grid-cols-2 mt-4">
    <div className="w-[310px]">
       ...
       <div className='-ml-5'> <FormDisplay /></div>
